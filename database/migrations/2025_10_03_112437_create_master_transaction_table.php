...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement('
            CREATE UNIQUE INDEX IF NOT EXISTS master_transaction_kode_unique_active
            ON master_transaction (kode)
    ...
    {
        DB::statement('DROP INDEX IF EXISTS master_transaction_kode_unique_active');
