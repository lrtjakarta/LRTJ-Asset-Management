...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement('
            CREATE UNIQUE INDEX IF NOT EXISTS master_status_kode_unique_active
            ON master_status (kode)
    ...
    {
        DB::statement('DROP INDEX IF EXISTS master_status_kode_unique_active');
