...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement('
            CREATE UNIQUE INDEX IF NOT EXISTS master_sub_category_kode_unique_active
            ON master_sub_category (kode)
    ...
    {
        DB::statement('DROP INDEX IF EXISTS master_sub_category_kode_unique_active');
