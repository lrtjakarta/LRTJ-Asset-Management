    ...
    <script>
        (function() {
            ...
            const table = $('#tableMasterSubCategory').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.sub_category.data') }}",
                order: [
                    [4, 'desc']
                ],
                columns: [{
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        url: "{{ route('master.sub_category.delete', ':uuid') }}".replace(':uuid',
                            uuid),
                        type: 'DELETE',
                        data: {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Deleted',
                            text: res.message || 'Sub Category deleted.'
                        });
                    }).fail(function(xhr) {
                        Swal.fire({
                            icon: 'error',
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            {{-- <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="#" class="btn btn-sm fw-bold btn-danger" data-bs-toggle="modal"
                    data-bs-target="#kt_modal_new_target">Add Sub Category</a>
            </div> --}}
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Master Sub Category Data</span>
                                </h3>
                            ...
                            <div class="card-body py-3">
                                ...
                                <table id="tableMasterSubCategory"
